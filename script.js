...
const block10 = new Card('CssMemSlider','./projects/cssMemSlider/index.html','Deploy', 'May 2022')
const block11 = new Card('Virtual-keyboard','./projects/virtual-keyboard/index.html','Deploy', 'May 2022')
const block12 = new Card('Core-js-101(3 of 8)','./projects/core-js-101/src/','Code', 'May 2022')
const block13 = new Card('Basic-js(13 of 25)','./projects/basic-js/src/','Code', 'May 2022')
const block14 = new Card('Visualizer','./projects/visualizer/index.html','Deploy', 'September 2022')
const block15 = new Card('Sandbox-painter','./projects/sandbox-painter/index.html','Deploy', 'Jule 2022')